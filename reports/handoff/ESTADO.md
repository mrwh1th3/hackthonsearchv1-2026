...
- **Deriva anotada:** el remoto tiene una migración `003_pistas_recalibrada_2b` (20260912074245) sin archivo en `db/`. No interactúa con 014–017 y es anterior a esta sesión, pero una instalación limpia desde `db/` no reproduce ese registro. Comprobar antes del demo que `db/003_pistas.sql` ya contiene la calibración y que el nombre remoto es solo historia, o reponer el archivo.
